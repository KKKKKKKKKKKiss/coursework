...
class Status(models.TextChoices):
    ...
    INCORRECT_DATA = 'INCORRECT_DATA', 'Введены неверные данные'
...
class Repair(models.Model):
    ...
    explanation = models.TextField(verbose_name="Примечание")

    idcomp = models.CharField(max_length=50, verbose_name="ID предмета", blank=True, null=True)
